...
//	public Encomienda crearEncomienda() {
		 ...
		 * y se pida la informaci�n del paquete al empleado
		 * y se cree el paquete que ser� retornado por el 
		 * m�todo 
		 * 
		 * Usar el atributo est�tico "clientes" de la oficina-bodega para ver
		 * si el usuario (tanto remitente como destinatario)
		 * ya est� registrado en la base de datos (lista) y no 
		 * tener que volver a llenar todos sus datos. En caso
		 * de que no est�, agregarlo a OficinaBodega.clientes
		 * 
		 * 
		 */
	...
	public void realizarEnvio(Encomienda enc, Cliente destinatario) {
		// TODO: Este lo podemos mirar despu�s
	}
